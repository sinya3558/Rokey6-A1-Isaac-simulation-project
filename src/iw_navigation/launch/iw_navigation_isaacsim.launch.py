...
def generate_launch_description():
    ...
    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join(
            get_package_share_directory("iw_navigation"), "params", "iw_navigation_params.yaml"
        ),
    )
    ...
    rviz_config_dir = os.path.join(get_package_share_directory("iw_navigation"), "rviz2", "iw_navigation.rviz")
